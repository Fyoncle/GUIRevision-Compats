...
body:
  ...
  - type: input
    id: gr_version
    attributes:
      label: GUI Revision version
      description: >-
        Which version of GUI Revision are you using?
      placeholder: v1.10
    validations:
      required: true
  - type: input
    ...
    attributes:
      label: GUI Revision Compats version
      description: >-
        Which version of GUI Revision Compats are you using?
      placeholder: v1.0
    validations:
      required: true
  - type: textarea
    ...
    attributes:
      ...
      placeholder: >-
        Version v1.x not working on Minecraft 1.xx.x
    validations:
      required: true
  - type: textarea
    id: steps
    attributes:
      ...
      placeholder: |
        1. Install GUI Revision & GUI Revision Compats on Minecraft 1.xx.x
        2. Join a world
